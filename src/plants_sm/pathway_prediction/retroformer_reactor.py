...
class Retroformer(Reactor):
    ...
    def __init__(self):
        ...
        retroformer_path = os.path.join(BASE_DIR, "pathway_prediction", "retroformer", "saved_models",
                                "model.pt")
        vocab_path = os.path.join(BASE_DIR, "pathway_prediction", "retroformer", "saved_models",
                                   "vocab_share.pk")
        self.model_retroformer, self.args = prepare_retroformer(device, beam_size, exp_topk, path=retroformer_path, vocab_path=vocab_path)
