...
class ModelsDownloadPaths(Enum):
    ...
    ESM1B_PIPELINE = "https://zenodo.org/records/17190861/files/ESM1b_pipeline.zip?download=1"
    ESM2_PIPELINE = "https://zenodo.org/records/17190861/files/ESM2_pipeline.zip?download=1"
